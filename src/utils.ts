...
export async function findAssociatedTokenAddress(
    owner: PublicKey, tokenMintAddress: PublicKey): Promise<PublicKey> {
...
export async function checkIfAccountExists(
    connection: Connection, account: PublicKey): Promise<boolean> {
...
export async function createAssociatedTokenAccountIx(
    fundingAddress: PublicKey, walletAddress: PublicKey,
    splTokenMintAddress: PublicKey) {
  const associatedTokenAddress =
      await findAssociatedTokenAddress(walletAddress, splTokenMintAddress);
...
export async function createSolAccount(
    ...
    payer: PublicKey): Promise<[TransactionInstruction, Keypair]> {
